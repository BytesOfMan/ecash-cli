 ...
 */
async function printConfirmedTxHistory(tokenId, page, pageSize) {
    let response;
    try {
        response = await chronik.tokenId(tokenId).confirmedTxs(page, pageSize);
    } catch (err) {
...
printConfirmedTxHistory(tokenId, page, pageSize);
